      ...
      <div className="bg-white shadow rounded-lg p-6">
        <div className="flex items-center space-x-6">
          ...
          <div className="ml-auto space-x-2">
            <Link to={`/email/${student.id}`} className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-green-700">
              Send Email
            </Link>
            <Link to={`/edit/${student.id}`} className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">
              Edit Profile
            </Link>
            <button
