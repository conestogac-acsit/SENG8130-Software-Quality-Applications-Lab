...
describe('getStudents', () => {
  ...
  it('should return totalPages as 3 on page 3', () => {
    const result = getStudents(3, 10);
    expect(result.totalPages).toBe(3);
  });
  ...
  it('should return correct first student ID on page 1', () => {
    const result = getStudents(1, 10);
    expect(result.data[0].id).toBe("1");
  });
  it('should return total as 25 on page 1', () => {
    const result = getStudents(1, 10);
    expect(result.total).toBe(25);
  });
  it('should return totalPages as 3 on page 1', () => {
    const result = getStudents(1, 10);
    expect(result.totalPages).toBe(3);
  });
});