...
describe('parseCsv - Student', () => {
  ...
  it('throws error if required student fields are missing', async () => {
    ...
    await expect(parseCsv<Student>(file, "Student")).rejects.toThrow(/Missing required fields/);
  });
...
describe('parseCsv - Evaluation', () => {
  ...
  it('throws error if required evaluation fields are missing', async () => {
    ...
    await expect(parseCsv<Evaluation>(file, "Evaluation")).rejects.toThrow(/Missing required fields/);
  });
  ...
  it('throws an error for completely empty file', async () => {
    ...
    await expect(parseCsv(file, "Evaluation")).rejects.toThrow(/Missing required fields/);
  });
